...
export function OverallSummaryContainer({ summary }) {
    ...
    const items = [
        ...
        { name: "Zimbabwe", active: scrolled > 66.6, link: 'https://zimcitizenswatch.org', target: '__blank', map: "/maps/zw.svg" }
    ]
        ...
        <div className="grid grid-cols-3 container m-auto mt-[8em]">
            <div className="flex flex-row">
                ...
                <div className="basis-2/3">
                    ...
                    <Button color="orange">
                        <a className="flex flex-row gap-4 text-[10px]" href={items.find((obj) => obj.active === true).link} target={items.find((obj) => obj.active === true).target}>
